...
export const coLocatedTemplate: ConfigTemplate = {
  ...
  generate: (basePath: string): UserConfig => ({
    ...
    archive: {
      ...
      bios: createPath(`${basePath}/Archive/BIOS`, 'System BIOS files', false),
      metadata: createPath(
    ...
    workspace: {
      ...
      logs: createPath(`${basePath}/Workspace/Logs`, 'Pipeline execution logs'),
      backups: createPath(
...
export const distributedTemplate: ConfigTemplate = {
  ...
  generate: (basePath: string): UserConfig => ({
    ...
    sync: {
      ...
      saveStates: createPath('/mnt/nas/RetroArch/states', 'Save states', false),
    },
    workspace: {
      processing: createPath(
