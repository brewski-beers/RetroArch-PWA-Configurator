    ...
    rules: [
        {
            id: 'E2E-001',
            name: 'Use Test IDs',
            description: 'Prefer data-testid for component testing. Use semantic selectors (getByRole, getByLabel) for accessibility verification and structural HTML (body, meta tags).',
            enabled: true,
            severity: 'critical',
            category: 'e2e',
        },
